...
const Header2 = () => {
  ...
  return (
    <header className="container bg-yellow-500 rounded-tl-[30px] rounded-tr-[30px] md:rounded-tl-[60px] md:rounded-tr-[60px]">
      ...
      {openMenu && (
        <div className="pb-12 fixed xl:hidden top-0 right-0 bg-white w-[218px] md:w-[374px] h-screen z-50 flex flex-col transition-transform duration-300 ease-in-out translate-x-0 opacity-100">
          <button
